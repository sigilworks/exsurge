export const Units = {
    ...
    ToDeviceIndependent: function(n, inputUnits) {
        switch (inputUnits) {
            case Centimeters:
                return n * this.DIU_PER_CENTIMETER;
            case Millimeters:
                return n * this.DIU_PER_CENTIMETER / 10;
            case Inches:
                return n * this.DIU_PER_INCH;
            default:
                return n;
        }
    },
...
var __StaffOffsetToStep = [Steps.Do, Steps.Re, Steps.Mi, Steps.Fa, Steps.So, Steps.La, Steps.Ti]; // no accidentals in this one
